...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-black border-t border-gray-300 dark:border-gray-700 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 justify-between">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center hover:translate-x-[-5px] gap-3 duration-300 text-gray-800 dark:text-gray-200 group">
                <Mail className="w-5 h-5 text-gray-600 dark:text-gray-400  transition-opacity" />
                <span className="text-sm  transition-all">
                  omarahmedelnadey@gmail.com
                </span>
              </li>
              <li className="flex items-center hover:translate-x-[-5px] gap-3 duration-300 text-gray-800 dark:text-gray-200">
