                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <Button
                      type="submit"
                      disabled={isLoading}
                      className="w-full py-4 text-lg font-semibold bg-gray-900 dark:bg-white text-white dark:text-black hover:bg-indigo-600 dark:hover:bg-gray-200 rounded-xl transition-all transform hover:-translate-y-0.5"
                    >
                      {isLoading ? (
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <Button
                      type="submit"
                      disabled={isLoading}
                      className="w-full py-4 text-lg font-semibold bg-gray-900 dark:bg-white text-white dark:text-black hover:bg-green-600 dark:hover:bg-green-400 hover:text-white rounded-xl transition-all transform hover:-translate-y-0.5"
                    >
                      {isLoading ? (
                        <Loader2 className="animate-spin" />
                      ) : (
